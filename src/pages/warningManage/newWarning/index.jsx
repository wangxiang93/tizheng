...
export default config({
    ...
    const columns = [
        { title: '指标名称', dataIndex: 'account' },
        { title: '告警数值', dataIndex: 'name' },
        { title: '告警级别', dataIndex: 'enabled', render: (value) => options.enabled.getTag(!!value) },
        { title: '负责部门', dataIndex: 'mobile' },
        { title: '负责人', dataIndex: 'email' },
        { title: '告警时间', dataIndex: 'email' },
        {
            title: '操作',
            key: 'operator',
            width: 150,
