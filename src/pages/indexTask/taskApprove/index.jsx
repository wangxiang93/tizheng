...
export default config({
    ...
    const columns = [
        { title: '任务编号', dataIndex: 'account', width: 100 },
        { title: '任务负责人', dataIndex: 'name', width: 100 },
      
        { title: '联系人', dataIndex: 'email', width: 100 },
        { title: '手机号码', dataIndex: 'email', width: 100 },
        
        { title: '所属部门', dataIndex: 'email', width: 100 },
        
        { title: '是否过期', dataIndex: 'email', width: 100 },
        {
            title: '操作',
            key: 'operator',
            width: 150,
